...
@Tag(
    ...
    description =
        "An API capability that allows client applications to refresh authentication token.")
public class RefreshTokenApiResource {
  ...
  @Autowired
  public RefreshTokenApiResource(
  ...
  @Operation(
      ...
      description =
          "Provide a new access token and invalidates all other issued access and refresh tokens.")
  @RequestBody(
      required = true,
      content =
          @Content(
  ...
  @ApiResponses({
    ...
    @ApiResponse(responseCode = "401", description = "Unauthenticated. Please login")
  })
  public String refreshToken() {
