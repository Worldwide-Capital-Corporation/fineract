...
import org.apache.fineract.farmersbank.kyc.data.response.MonitoringList;
...
public interface MonitoringListClient {
    ...
    Call<List<MonitoringList>> monitoringList(@Header("api-key") String apiKey,
    ...
    Call<List<MonitoringList>> corpMonitoringList(@Header("api-key") String apiKey,
